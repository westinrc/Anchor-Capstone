CREATE DATABASE  IF NOT EXISTS `capstone_DB` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `capstone_DB`;
...
CREATE TABLE `patient` (
  ...
  PRIMARY KEY (`index`),
  CONSTRAINT `index_FK` FOREIGN KEY (`index`) REFERENCES `visit` (`index`) ON DELETE CASCADE ON UPDATE CASCADE
